...
1. Check if .orbit/config.md exists:
   ```bash
...
Update .orbit/codebase/CONCERNS.md with scan results.
...
---
*Auto-generated by /orbit:quality-gate*
...
Updated: .orbit/codebase/CONCERNS.md
...
<output>
- Updated .orbit/codebase/CONCERNS.md with SonarQube section
