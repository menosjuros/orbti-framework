...
- Files: `components/MobileNav.tsx` (line ~45, logout handler)
...
- Files: `components/AvatarUpload.tsx` (upload handler)
...
- Files: `app/api/checkout/route.ts`, `app/api/webhooks/stripe/route.ts`, `lib/subscription.ts`
...
- Files: `app/error.tsx`, `components/ErrorBoundary.tsx`
