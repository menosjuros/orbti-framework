...
Template for `.orbit/codebase/STRUCTURE.md` - captures physical file organization.
...
**New Slash Command:**
- Primary code: `src/commands/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `src/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `src/workflows/{name}.md`
- Usage: Reference from command with `@src/workflows/{name}.md`

**New Reference Document:**
- Implementation: `src/references/{name}.md`
...
**src/**
- Purpose: Resources installed to ~/.claude/orbit-framework/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**.orbit/**
- Purpose: Project state (created in target projects)
- Source: Generated by /orbit:observe
